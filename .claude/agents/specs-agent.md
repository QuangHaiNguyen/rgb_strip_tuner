...
2. Search `docs/specs/` for existing specifications and this project's technical constraints (see [CLAUDE.md](CLAUDE.md)) to ensure there is no conflict or duplication.
